/*
* This class implements Insertion Sort with a preprocessing step (quickSortModified).
* Recursively partitions the array, then switches to Insertion Sort for small subarrays.
* Used to benchmark the proposed algorithm with other sorting algorithms in table 3.
*/
